...
namespace UniversityData.Migrations
{
    ...
    [Migration("20230828021029_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityData.Entites.Course", b =>
                {
            ...
            modelBuilder.Entity("UniversityData.Entites.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("UniversityData.Entites.Student", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniversityData.Entites.Enrollment", b =>
                {
                    b.HasOne("UniversityData.Entites.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniversityData.Entites.Student", "Student")
                        .WithMany("Enrollments")
